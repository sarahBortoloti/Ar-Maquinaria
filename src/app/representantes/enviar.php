...
$estado = $_POST['estado'];
$cidade = $_POST['cidade'];
$estadoRepresentante = $_POST['estado']
...
<table width='510'  bgcolor='#fff'>
    ...
    <tr>
        <td width='320'><b>estado: </b>$estado</td>
    </tr>

    <tr>
        <td width='320'><b>cidade: </b>$cidade</td>
    </tr>

    <tr>
        <td width='320'><b>estado representante: </b>$estado</td>
    </tr>
...
$destino = $emailenviar;
$assunto = "Representante solicitado pelo Site";
